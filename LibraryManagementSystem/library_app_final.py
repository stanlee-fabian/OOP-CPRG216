'''
OOP1 CPRG-216-H Library Management Application

This Python Script was made in accordance to the requirements of CPRG216-H Project: Classes.
It provides features like book search, borrowing, returning, adding, and removing books.
